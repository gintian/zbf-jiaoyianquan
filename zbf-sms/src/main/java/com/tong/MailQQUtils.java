...
public class MailQQUtils {
     ...
     * 发件人
     */
    private static String from="2667648594@qq.com";
    /**
     * 发送邮件的授权码
     */
    private static String authCode="mzvuwblgfdkuebgi";
 ...
 public static void sendMessage(String to,String code,String webName,String linkhref){
     try {
         ...
         msg.setSubject("【"+webName+"】您正在申请邮箱注册，验证码为："+code+"，5分钟内有效！");
    ...
    public static void main(String[] args) {
        sendMessage("2667648594@qq.com","65456465656","三豆网络","");
    }
