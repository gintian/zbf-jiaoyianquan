...
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
        ...
        String moduleName = "zbf-elastic-job";
//        String moduleName = "";
        // 代码生成器
...
//        pc.setModuleName(scanner("请输入你的包名"));
        //需要修改
        pc.setParent("com.tong");//你哪个父目录下创建包
...
//        strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
        //需要修改
        strategy.setInclude("zbf_job_type","zbf_export_task_header","zbf_export_task_detail");
